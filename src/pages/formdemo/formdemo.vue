  ...
  <view>
    <page-wraper>
      ...
      <wd-form ref="form" :model="model" :rules="rules">
        <wd-cell-group custom-class="group border-rd-lg" title="基础信息" border>
          <wd-input
            label="优惠券名称"
            label-width="100px"
            :maxlength="20"
        ...
        <wd-cell-group custom-class="group border-rd-lg" title="时间和地址" border>
          <wd-datetime-picker
            label="时间"
            label-width="100px"
            placeholder="请选择时间"
        ...
        <wd-cell-group custom-class="group border-rd-lg" title="其他信息" border>
          <wd-textarea
            label="活动细则"
            label-width="100px"
            type="textarea"
