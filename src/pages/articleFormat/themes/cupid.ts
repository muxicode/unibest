...
export const cupidThemeParser: ThemeParser = {
  ...
  parse: (markdown: string, md?: any, hljs?: any, fontSize: string = '14'): string => {
    ...
    const originalStyles = {
      ...
      h3: 'margin-top: 15px; margin-bottom: 8px; margin-left: 0px; margin-right: 0px; padding-top: 0px; padding-bottom: 0px; padding-left: 0px; padding-right: 0px; display: block; font-size: 16px;',
