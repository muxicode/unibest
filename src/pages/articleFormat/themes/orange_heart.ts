...
// 橙心主题解析器 (橙色风格)
export const orangeHeartThemeParser: ThemeParser = {
  name: 'theme-orange-heart',
  description: '橙心',
  parse: (markdown: string, md?: any, hljs?: any, fontSize: string = '14'): string => {
    ...
    // 定义主题样式
    const themeStyles = applyFontSizeToTheme(
      {
        wrapper:
        ...
        h1Content:
          'font-size: 16px; font-size: 20px; color: rgb(89, 89, 89); line-height: 1.5em; letter-spacing: 0em; text-align: left; font-weight: bold; display: block;',
        ...
        strong:
          'color: rgb(239, 112, 96); font-weight: bold; background-attachment: scroll; background-clip: border-box; background-color: rgba(0, 0, 0, 0); background-image: none; background-origin: padding-box; background-position-x: 0%; background-position-y: 0%; background-repeat: no-repeat; background-size: auto; width: auto; height: auto; margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; padding-top: 0px; padding-bottom: 0px; padding-left: 0px; padding-right: 0px; border-top-style: none; border-bottom-style: none; border-left-style: none; border-right-style: none; border-top-width: 2px; border-bottom-width: 2px; border-left-width: 2px; border-right-width: 2px; border-top-color: rgba(0, 0, 0, 0.4); border-bottom-color: rgba(0, 0, 0, 0.4); border-left-color: rgba(0, 0, 0, 0.4); border-right-color: rgba(0, 0, 0, 0.4); border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px;',
        ...
        del: 'color: rgb(239, 112, 96); font-style: italic;',

        hr: 'margin-top: 5px; margin-bottom: 5px; margin-left: 0px; margin-right: 0px; padding-top: 0px; padding-bottom: 0px; padding-left: 0px; padding-right: 0px; border-top-style: solid; border-bottom-style: none; border-left-style: none; border-right-style: none; border-top-width: 1px; border-bottom-width: 2px; border-left-width: 2px; border-right-width: 2px; border-top-color: rgb(239, 112, 96); border-bottom-color: rgba(0, 0, 0, 0.4); border-left-color: rgba(0, 0, 0, 0.4); border-right-color: rgba(0, 0, 0, 0.4); border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px; background-attachment: scroll; background-clip: border-box; background-color: rgba(0, 0, 0, 0); background-image: none; background-origin: padding-box; background-position-x: 0%; background-position-y: 0%; background-repeat: no-repeat; background-size: auto; width: auto; height: 1px;',
    ...
    markdownIt.renderer.rules.image = (tokens, idx) => {
      ...
      return `<figure data-tool="mdnice编辑器" style="${themeStyles.figure}"><img src="${src}" alt="${alt}" style="${themeStyles.figureImg}"></figure>`
    }
    ...
    html = html.replace(/<image([^>]*)>/gi, (match, attrs) => {
      ...
      return `<img src="${src}" data-tool="mdnice编辑器" style="${themeStyles.figureImg}">`
    })
    ...
    html = html.replace(/<img([^>]*)>/gi, (match, attrs) => {
      ...
      return `<img${attrs} style="${themeStyles.figureImg}">`
    })
