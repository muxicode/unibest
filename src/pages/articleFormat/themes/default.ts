...
export const defaultThemeParser: ThemeParser = {
  ...
  parse: (markdown: string, md?: any, hljs?: any, fontSize: string = '14'): string => {
    ...
    const themeStyles = {
      ...
      p: `color: rgb(89, 89, 89); font-size: ${fontSize}px; line-height: 1.8em; letter-spacing: 0.02em; text-align: left; text-indent: 0em; margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; padding-top: 12px; padding-bottom: 12px; padding-left: 0px; padding-right: 0px;`,
