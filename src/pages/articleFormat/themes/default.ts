...
export const defaultThemeParser: ThemeParser = {
  ...
  parse: (markdown: string, md: any, hljs: any): string => {
    ...
    try {
      // 主题样式对象
      const themeStyles = {
        h1: 'font-size: 24px; color: rgb(119, 48, 152); line-height: 1.5em; font-weight: bold;',
        h2: 'font-size: 22px; color: rgb(119, 48, 152); line-height: 1.5em; border-bottom: 1px solid rgb(119, 48, 152); text-align: center; padding-bottom: 10px; font-weight: bold;',
        h3: 'font-size: 20px; color: rgb(119, 48, 152); line-height: 1.5em; font-weight: bold;',
        h4: 'font-size: 18px; color: rgb(119, 48, 152); line-height: 1.5em; font-weight: bold;',
        h5: 'font-size: 16px; color: rgb(119, 48, 152); line-height: 1.5em; font-weight: bold;',
        h6: 'font-size: 14px; color: rgb(119, 48, 152); line-height: 1.5em; font-weight: bold;',
        p: 'margin-top: 5px; margin-bottom: 5px; color: rgb(90, 90, 90); font-size: 15px; line-height: 1.8em; letter-spacing: 0.02em; text-align: left; font-weight: normal;',
        strong: 'color: rgb(0, 0, 0); font-weight: bold;',
        em: 'font-style: italic;',
        a: 'color: rgb(119, 48, 152); text-decoration: none;',
        ul: 'list-style-type: disc; margin-top: 8px; margin-bottom: 8px; padding-left: 25px; color: rgb(0, 0, 0);',
        ol: 'list-style-type: decimal; margin-top: 8px; margin-bottom: 8px; padding-left: 25px; color: rgb(0, 0, 0);',
        li: 'margin-top: 5px; margin-bottom: 5px;',
        blockquote:
          'margin-top: 20px; margin-bottom: 20px; padding: 10px 20px; border-left: 3px solid rgb(150, 84, 181); border-right: 1px solid rgb(150, 84, 181); background-color: rgb(251, 249, 253);',
        code: 'background-color: rgba(27, 31, 35, 0.05); padding: 2px 4px; margin: 0 2px; border-radius: 4px; font-family: Consolas, Monaco, Menlo, monospace; word-break: break-all;',
        img: 'display: block; margin: 0 auto; max-width: 100%;',
        hr: 'margin-top: 10px; margin-bottom: 10px; border-top: 1px solid rgb(119, 48, 152); height: 1px;',
        wrapper:
          'font-family: Optima, PingFangSC-regular, serif; font-size: 16px; color: rgb(0, 0, 0); line-height: 1.5em; word-break: break-word; text-align: left; padding: 10px; background-color: #ffffff;',
      ...
      md.renderer.rules.html_inline = function (tokens, idx) {
        ...
        // 保留color和style属性
        if (content.includes('<font') && content.includes('color=')) {
          return content // 不修改原始HTML
        }
      ...
      md.renderer.rules.paragraph_open = function () {
        return `<p data-tool="mdnice编辑器" style="${themeStyles.p};user-select: text; -webkit-user-select: text;" selectable="true">`
      }
      ...
      // 包装 HTML 并应用主题样式
      return `
        <section style="${themeStyles.wrapper}" selectable="true">
          ${html}
        </section>
      `
    } finally {
